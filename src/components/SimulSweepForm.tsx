...
import { FormField, SimulSweepParameters, SimulSweepParamEntry } from '../types';
...
export const SimulSweepForm: React.FC<SimulSweepFormProps> = ({ onGenerate }) => {
  ...
  const handleParamChange = (index: number, field: keyof SimulSweepParamEntry, value: any) => {
    setParams(prev => {
      const updated = [...prev];
  ...
  const validate = (): boolean => {
    ...
    params.forEach((param, index) => {
      ...
      if (param.step === undefined || param.step === null || param.step === 0) {
        newErrors[`param_${index}_step`] = 'Step size is required and must not be zero';
      }
    });
          ...
          <div key={index} className="qmeasure-param-entry">
            ...
            <div className="qmeasure-form-group">
              ...
              <input
                ...
                onChange={(e) => handleParamChange(index, 'paramPath', e.target.value)}
              ...
              {errors[`param_${index}_paramPath`] && (
                <div className="qmeasure-form-error">{errors[`param_${index}_paramPath`]}</div>
              )}
            </div>
            ...
            <div className="qmeasure-param-row">
              <div className="qmeasure-form-group">
                ...
                <input
                  ...
                  className="qmeasure-form-input"
                  value={param.start}
                  onChange={(e) => handleParamChange(index, 'start', Number(e.target.value))}
                  step="any"
                />
                {errors[`param_${index}_start`] && (
                  <div className="qmeasure-form-error">{errors[`param_${index}_start`]}</div>
                )}
              </div>
              ...
              <div className="qmeasure-form-group">
                ...
                <input
                  ...
                  className="qmeasure-form-input"
                  value={param.stop}
                  onChange={(e) => handleParamChange(index, 'stop', Number(e.target.value))}
                  step="any"
                />
                {errors[`param_${index}_stop`] && (
                  <div className="qmeasure-form-error">{errors[`param_${index}_stop`]}</div>
                )}
              </div>
              ...
              <div className="qmeasure-form-group">
                ...
                <input
                  ...
                  className="qmeasure-form-input"
                  value={param.step}
                  onChange={(e) => handleParamChange(index, 'step', Number(e.target.value))}
                  step="any"
                />
                {errors[`param_${index}_step`] && (
                  <div className="qmeasure-form-error">{errors[`param_${index}_step`]}</div>
                )}
              </div>
            </div>
          </div>
